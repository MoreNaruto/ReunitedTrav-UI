...
export const failedReceiveEventsApiData = (error) => ({
  type: FAILED_RECEIVE_EVENTS_API_DATA, error,
});
export const createdEventApiData = (payload) => ({
  type: CREATED_EVENT_API_DATA, payload,
});
export const failedCreatedEventApiData = (payload) => ({
  type: FAILED_CREATED_EVENT_API_DATA, payload,
});
